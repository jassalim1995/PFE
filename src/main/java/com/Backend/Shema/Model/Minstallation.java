...
@Document(collection = "Minstallation")
public class Minstallation {
	@Id
	private String Id;
	...
	public Minstallation(String id, String disponible, String fichier, String valide, String commentaire) {
		super();
		Id = id;
		this.disponible = disponible;
		this.fichier = fichier;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Minstallation other = (Minstallation) obj;
		if (Id == null) {
			if (other.Id != null)
				return false;
