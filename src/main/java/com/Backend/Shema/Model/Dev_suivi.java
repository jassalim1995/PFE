...
@Document(collection = "Dev_suivi")
public class Dev_suivi {
	@Id
	private String id;
	...
	public Dev_suivi(String id, String tache, String activite, String statut, String avancement, String echeance,
